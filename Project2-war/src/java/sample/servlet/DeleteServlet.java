...
public class DeleteServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Object impObj = context.lookup("ImpJNDI");
            ImportSessionBeanRemote impPoji = (ImportSessionBeanRemote)impObj;
            
            impPoji.deleteImport(id);
            //-----------------------------------------------------------------------------------
            Object proObj = context.lookup("ProJNDI");
            ProductSessionBeanRemote proPoji = (ProductSessionBeanRemote)proObj;
            
            proPoji.deleteProduct(id);
            
            RequestDispatcher rd = request.getRequestDispatcher(viewServlet);
            rd.forward(request, response);
        } catch (NamingException ex) {
            log("DeleteServlet _ JNDI " + ex.getMessage());
        } finally {
            out.close();
        }
    }
